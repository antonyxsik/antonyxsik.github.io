...
<p align="center" style="margin: 20px 0;">
  ...
  <span style="font-size: smaller;"><strong>Figure 4:</strong> A slice of our high resolution, simulated data, where lighter colors represent a higher vertical velocity of air. Many small-scale, turbulent processes are shown, ranging from a few meters to a few km in size. The vertical profile of the average temperature (theta bar) is also imposed on the plot. (Courtesy of S. Shamekh) </span>
</p>
...
<p align="center" style="margin: 20px 0;">
  <img src='/images/LES.png' width='500'><br/>
